...
def base_mohid(filepath, varname, timestep, s_rho):
    ...
    if varname == "elev":
        base_fname = '/DATA/PYTHON/output/mohid2k/base_%s_%s_%04d_%s_00.nc'% \
                       (foldername.lower(),yyyymmdd12,int(timestep),varname)
    else:
        base_fname = '/DATA/PYTHON/output/mohid2k/base_%s_%s_%04d_%s_%02d.nc'% \
