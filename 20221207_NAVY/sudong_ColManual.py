# -*- coding: utf-8 -*-
# 수동 모듈
# mng_data_col_log테이블에서 data_date가 돌리고 싶은 날짜이고 reg_date가 '9999-01-01 00:00:00.000'인 것을 추려내서 해당 no에 맞는 모델을 삭제 후 sudong_ColManual.py을 돌려야 한다. 
import os
import sys
import pandas as pd
import datetime
...
def manual_col_main(data_no, col_date, col_time):
    ...
    if col_stat == '1':
        if data_cate1 == 'obs':
            ...
            sudong_ObsMain.main(obs_date, station, data_name)
