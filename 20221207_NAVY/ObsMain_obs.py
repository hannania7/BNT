...
class ObsObject:
    ...
    def _str_to_datetime(self, str_date):
        ...
        """
        str_datetime_pro = datetime.datetime.strptime(str_date, "%Y%m%d%H%M")
        str_datetime_cal = str_datetime_pro.strftime('%Y%m%d%H:%M')
        str_datetime = datetime.datetime.strptime(str_datetime_cal, "%Y%m%d%H:%M")
        return str_datetime
