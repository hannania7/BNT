...
def read_query(sql):
    ...
    return result
for i in range(10):
	if not os.path.exists(f'/DATA/HResolutionVisual/OUTPUT/json/zeta_salt_temp_sf/20211129/0{i}'):
		os.makedirs(f'/DATA/HResolutionVisual/OUTPUT/json/zeta_salt_temp_sf/20211129/0{i}')
for i in range(10,24):
	if not os.path.exists(f'/DATA/HResolutionVisual/OUTPUT/json/zeta_salt_temp_sf/20211129/{i}'):
		os.makedirs(f'/DATA/HResolutionVisual/OUTPUT/json/zeta_salt_temp_sf/20211129/{i}')
file_name = os.listdir('/DATA/recv/2021/obs/sf/')
...
for i in file_name:
	if i[-12:-4] == '20210602':
		print(i[0:7])
		check_sql = f"select * from station where obs_post_id = '{i[0:7]}';"
		...
		date_data = '20211129'
		with open(f"/DATA/recv/2021/obs/sf/{i}", 'r', encoding='ISO-8859-1') as fp:
			...
			#0
					...
					if split_obs_data[0][0:16] == f'2021/06/02 00:00':
						with open('/DATA/HResolutionVisual/OUTPUT/json/zeta_salt_temp_sf/20211129/00/temp.json', 'w', encoding="UTF-8") as var_f:
			...
			#1
					...
					if split_obs_data[0][0:16] == f'2021/06/02 01:00':
						with open('/DATA/HResolutionVisual/OUTPUT/json/zeta_salt_temp_sf/20211129/01/temp.json', 'w', encoding="UTF-8") as var_f:
			...
			#2
					...
					if split_obs_data[0][0:16] == f'2021/06/02 02:00':
						with open('/DATA/HResolutionVisual/OUTPUT/json/zeta_salt_temp_sf/20211129/02/temp.json', 'w', encoding="UTF-8") as var_f:
			...
			#3
					...
					if split_obs_data[0][0:16] == f'2021/06/02 03:00':
						with open('/DATA/HResolutionVisual/OUTPUT/json/zeta_salt_temp_sf/20211129/03/temp.json', 'w', encoding="UTF-8") as var_f:
			...
			#4
					...
					if split_obs_data[0][0:16] == f'2021/06/02 04:00':
						with open('/DATA/HResolutionVisual/OUTPUT/json/zeta_salt_temp_sf/20211129/04/temp.json', 'w', encoding="UTF-8") as var_f:
			...
			#5
					...
					if split_obs_data[0][0:16] == f'2021/06/02 05:00':
						with open('/DATA/HResolutionVisual/OUTPUT/json/zeta_salt_temp_sf/20211129/05/temp.json', 'w', encoding="UTF-8") as var_f:
			...
			#6
					...
					if split_obs_data[0][0:16] == f'2021/06/02 06:00':
						with open('/DATA/HResolutionVisual/OUTPUT/json/zeta_salt_temp_sf/20211129/06/temp.json', 'w', encoding="UTF-8") as var_f:
			...
			#7
					...
					if split_obs_data[0][0:16] == f'2021/06/02 07:00':
						with open('/DATA/HResolutionVisual/OUTPUT/json/zeta_salt_temp_sf/20211129/07/temp.json', 'w', encoding="UTF-8") as var_f:
			...
			#8
					...
					if split_obs_data[0][0:16] == f'2021/06/02 08:00':
						with open('/DATA/HResolutionVisual/OUTPUT/json/zeta_salt_temp_sf/20211129/08/temp.json', 'w', encoding="UTF-8") as var_f:
			...
			#9
					...
					if split_obs_data[0][0:16] == f'2021/06/02 09:00':
						with open('/DATA/HResolutionVisual/OUTPUT/json/zeta_salt_temp_sf/20211129/09/temp.json', 'w', encoding="UTF-8") as var_f:
			...
			#10
					...
					if split_obs_data[0][0:16] == f'2021/06/02 10:00':
						with open('/DATA/HResolutionVisual/OUTPUT/json/zeta_salt_temp_sf/20211129/10/temp.json', 'w', encoding="UTF-8") as var_f:
			...
			#11
					...
					if split_obs_data[0][0:16] == f'2021/06/02 11:00':
						with open('/DATA/HResolutionVisual/OUTPUT/json/zeta_salt_temp_sf/20211129/11/temp.json', 'w', encoding="UTF-8") as var_f:
			...
			#12
					...
					if split_obs_data[0][0:16] == f'2021/06/02 12:00':
						with open('/DATA/HResolutionVisual/OUTPUT/json/zeta_salt_temp_sf/20211129/12/temp.json', 'w', encoding="UTF-8") as var_f:
			...
			#13
					...
					if split_obs_data[0][0:16] == f'2021/06/02 13:00':
						with open('/DATA/HResolutionVisual/OUTPUT/json/zeta_salt_temp_sf/20211129/13/temp.json', 'w', encoding="UTF-8") as var_f:
			...
			#14
					...
					if split_obs_data[0][0:16] == f'2021/06/02 14:00':
						with open('/DATA/HResolutionVisual/OUTPUT/json/zeta_salt_temp_sf/20211129/14/temp.json', 'w', encoding="UTF-8") as var_f:
			...
			#15
					...
					if split_obs_data[0][0:16] == f'2021/06/02 15:00':
						with open('/DATA/HResolutionVisual/OUTPUT/json/zeta_salt_temp_sf/20211129/15/temp.json', 'w', encoding="UTF-8") as var_f:
			...
			#16
					...
					if split_obs_data[0][0:16] == f'2021/06/02 16:00':
						with open('/DATA/HResolutionVisual/OUTPUT/json/zeta_salt_temp_sf/20211129/16/temp.json', 'w', encoding="UTF-8") as var_f:
			...
			#17
					...
					if split_obs_data[0][0:16] == f'2021/06/02 17:00':
						with open('/DATA/HResolutionVisual/OUTPUT/json/zeta_salt_temp_sf/20211129/17/temp.json', 'w', encoding="UTF-8") as var_f:
			...
			#18
					...
					if split_obs_data[0][0:16] == f'2021/06/02 18:00':
						with open('/DATA/HResolutionVisual/OUTPUT/json/zeta_salt_temp_sf/20211129/18/temp.json', 'w', encoding="UTF-8") as var_f:
			...
			#19
					...
					if split_obs_data[0][0:16] == f'2021/06/02 19:00':
						with open('/DATA/HResolutionVisual/OUTPUT/json/zeta_salt_temp_sf/20211129/19/temp.json', 'w', encoding="UTF-8") as var_f:
			...
			#20
					...
					if split_obs_data[0][0:16] == f'2021/06/02 20:00':
						with open('/DATA/HResolutionVisual/OUTPUT/json/zeta_salt_temp_sf/20211129/20/temp.json', 'w', encoding="UTF-8") as var_f:
			...
			#21
					...
					if split_obs_data[0][0:16] == f'2021/06/02 21:00':
						with open('/DATA/HResolutionVisual/OUTPUT/json/zeta_salt_temp_sf/20211129/21/temp.json', 'w', encoding="UTF-8") as var_f:
          ...
          #temp
					...
					if split_obs_data[0][0:16] == f'2021/06/02 22:00':
						with open('/DATA/HResolutionVisual/OUTPUT/json/zeta_salt_temp_sf/20211129/22/temp.json', 'w', encoding="UTF-8") as var_f:
			...
			#23
					...
					if split_obs_data[0][0:16] == f'2021/06/02 23:00':
						with open('/DATA/HResolutionVisual/OUTPUT/json/zeta_salt_temp_sf/20211129/23/temp.json', 'w', encoding="UTF-8") as var_f:
